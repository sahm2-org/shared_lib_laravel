...
/**
 * @property \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\DriverReward> $driverReward
 * @property int|null                                                                             $driver_reward_count
 * @property mixed                                                                                $id
 * @property \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\UserReward>   $userReward
 * @property int|null                                                                             $user_reward_count
 *
