 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\Order> $activeOrder
 * @property-read int|null $active_order_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\DriverAssignment> $assignments
 ...
 * @property-read \Saham\SharedLibs\Models\City|null $city
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\DriverPayout> $payouts
 * @property-read int|null $payouts_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Driver> $ratings
 * @property-read int|null $ratings_count
 * @property-write mixed $i_d_photo
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\Passport\Token> $tokens
 * @property-read int|null $tokens_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\DriverTransaction> $transactions
