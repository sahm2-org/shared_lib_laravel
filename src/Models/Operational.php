 ...
 * @property \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\Driver>                               $drivers
 * @property int|null                                                                                                     $drivers_count
 ...
 * @property \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\OperationalPayout>                    $payouts
 ...
 * @property \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\OperationalTransaction>               $transactions
...
class Operational extends Authenticatable
{
    ...
    protected $fillable = [
        'full_name', 'email', 'phone', 'avatar', 'avatarURL', 'password', 'phone_code', 'bank_name', 'bank_IBAN', 'system_driver_commission_percentage', 'system_driver_commission_amount',  'block',  'wallet', 'status', 'rang_kilo', 'time_to_assign', 'auto_assign', 'notification_id', 'device_id', 'device_type', 'os_version', 'notes_history',
    ];
