 ...
 * @property \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\FeastProduct> $feastProducts
 * @property int|null                                                                             $feast_products_count
 * @property \Saham\SharedLibs\Models\Partner|null                                                $partner
 * @property \Saham\SharedLibs\Models\Product|null                                                $product
 * @property \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\Product>      $products
 * @property int|null                                                                             $products_count
 * @property \Saham\SharedLibs\Models\Store|null                                                  $store
