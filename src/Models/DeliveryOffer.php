 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\DeliveryOfferDriver> $deliveryOffersDriver
 * @property-read int|null $delivery_offers_driver_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Saham\SharedLibs\Models\DeliveryOfferStore> $deliveryOffersStore
 * @property-read int|null $delivery_offers_store_count
